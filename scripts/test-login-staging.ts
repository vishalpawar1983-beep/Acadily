...
async function main() {
  await mongoose.connect('mongodb+srv://designermanjeets_db_user:Wu2F9CJyBAROC5G8@cluster-ims.h10y328.mongodb.net/flex_academy_staging?retryWrites=true&w=majority&appName=Cluster-ims');
  console.log('Connected to flex_academy_staging');
